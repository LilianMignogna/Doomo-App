...
class AccountFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        accountViewModel.getUserInfos(user!!, root, (activity as MainActivity))
    ...
    fun setUserInfos(user: User, view: View, activity: Activity){
        ...
        val ivProfilePicture: ImageView = view.findViewById(R.id.profile_picture)
        val imgProfilePicture = user.image
        Glide.with(activity.application).load(imgProfilePicture).into(ivProfilePicture)
